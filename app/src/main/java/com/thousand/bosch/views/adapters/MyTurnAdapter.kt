...
class MyTurnAdapter(
    ...
    private val id: Int,
    private val myTurn: List<MyTurn>?
) : RecyclerView.Adapter<MyTurnAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val itemLayout = itemView.findViewById(R.id.myTurnLayout) as ConstraintLayout
        val imageView = itemView.findViewById(R.id.myTurnImage) as ImageView
        val resultText = itemView.findViewById(R.id.myTurnResultText) as TextView
        val userName = itemView.findViewById(R.id.myTurnUserName) as TextView
        val leftTime = itemView.findViewById(R.id.myLeftTime) as TextView
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.my_turn_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Log.i("pushList 1 1", "" + myTurn!!.size)
        val tempObj = myTurn[position]
